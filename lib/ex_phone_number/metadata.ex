defmodule ExPhoneNumber.Metadata do
  ...
  def get_region_code_for_number_from_region_list(%PhoneNumber{} = phone_number, region_codes)
  ...
  def is_leading_zero_possible?(country_code) when is_number(country_code) do
    metadata =
      get_for_region_code_or_calling_code(country_code, get_region_code_for_country_code(country_code))
