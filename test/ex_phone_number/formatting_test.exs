  ...
  describe ".format/2" do
    context "US number" do
      ...
      it "should return correct value #8" do
        assert "000-000-0000" ==
                 format(PhoneNumberFixture.us_spoof_with_raw_input(), PhoneNumberFormats.national())
      end
    ...
    context "Numbers with extensions" do
      it "should return correct value #0" do
        assert "03-331 6005 ext. 1234" ==
                 format(%{PhoneNumberFixture.nz_number() | extension: "1234"}, PhoneNumberFormats.national())
      end

      it "should return correct value #1" do
        assert "tel:+64-3-331-6005;ext=1234" ==
                 format(%{PhoneNumberFixture.nz_number() | extension: "1234"}, PhoneNumberFormats.rfc3966())
      end

      it "should return correct value #2" do
        assert "650 253 0000 extn. 4567" ==
                 format(%{PhoneNumberFixture.us_number() | extension: "4567"}, PhoneNumberFormats.national())
      end
    end
  end
end
